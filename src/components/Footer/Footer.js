  ...
  return (
    ...
    <div className='row'>
        <div className='col'>
            ...
            <p>Phim fly nơi tự tập những bộ phim hot và đang trending, có độ phân giải cao và được bảo trì liên tục đảm bảo phim chạy suông mượt hơn bồ cũ tán tỉnh bạn. </p>
        </div>
           <div className='col'>
